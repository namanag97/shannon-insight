...
def main() -> int:
    ...
    batches = [
        ...
        },
        {
            ...
            "current": {"industry_packs": industries["pack_count"], "analytical_cases": vertical_cases, "evidence_sources": vertical_evidence, "raw_review_queue_records": canonical_refs["raw_queue_records"], "research_resolved_candidate_records": canonical_refs["research_resolved_candidate_records"], "remaining_open_research_records": canonical_refs["remaining_open_research_records"], "canonically_ratified_refs": canonical_refs["method_reference_frontier"]["canonically_ratified_distinct"], "unresolved_industry_refs": industries["canonical_reference_closure"]["unresolved_industry_or_subindustry_refs"], "unresolved_method_refs": canonical_refs["method_reference_frontier"]["remaining_open_research_distinct"], "unresolved_operation_refs": industries["canonical_reference_closure"]["unresolved_operation_refs"], "unresolved_source_class_refs": industries["canonical_reference_closure"]["unresolved_source_class_refs"], "data_shape_needs": vertical_shapes, "source_system_needs": vertical_sources},
