#!/usr/bin/env python3
"""Build deterministic model/decision product-adjudication views."""
...
SPEC = importlib.util.spec_from_file_location("shared_model_decision_adjudication_builder", SHARED)
