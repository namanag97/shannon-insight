...
| Product gates | 15 | 888 | Build, bind, appraise and execute unrelated-vertical acceptance |
| **Total** | **686** | **16,732** | |
...
`closure-tranches.jsonl` partitions all 686 current quotients and 16,732 atoms exactly once. The
