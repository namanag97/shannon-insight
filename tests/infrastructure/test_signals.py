...
class TestSignalEnum:
    ...
    def test_signal_scope_counts_add_up(self) -> None:
        """41 file + 15 module + 11 global = 67 total."""
        # 7 IR1 + 6 IR2 + 15 IR3 + 9 IR5t + 4 composites = 41 file
        #   IR3 extended: +CYCLE_MEMBER, +CYCLE_SIZE (13 → 15)
        #   IR5t extended: +CHANGE_ENTROPY (8 → 9)
