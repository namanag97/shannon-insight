#!/usr/bin/env python3
"""Build deterministic views for semantic metric/formula product adjudication."""
...
SPEC = importlib.util.spec_from_file_location("shared_semantic_metric_formula_builder", SHARED)
