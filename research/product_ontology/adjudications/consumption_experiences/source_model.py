...
def source() -> dict[str, Any]:
    ...
    artifacts: list[dict[str, Any]] = [
        ...
        artifact("neighbor.notification_delivery", "neighboring_product", "Notification delivery service", "import_only", "Owns channel delivery attempts and receipts, not analytical alert meaning.", ["evidence.prometheus.alertmanager", "evidence.grafana.notifications"]),
    ...
    semantics = [
        ...
        ("semantic.subscription", "Analytical subscription", "recipient, content, schedule, parameter, channel and cancellation contract"),
    ...
    boundary_decisions = [
        ...
        {"decision_id":"decision.consumption.alert_subscription","subject_ref":"semantic.subscription","disposition":"merge_into_capability_until_independent_service_proven","rationale":"Alert evaluation, alert state, report snapshot and channel delivery are separate meanings; bundling them in BI does not create one sovereign product.","evidence_refs":["evidence.prometheus.alertmanager","evidence.grafana.notifications","evidence.powerbi.subscription"]},
    ...
    libraries = [
        ...
        library("library.consumption.subscription_runner","semantic.subscription",["capability.run_subscription"],["Subscription","DeliveryIntent","DeliveryReceipt"],["plan_delivery","record_delivery"],["recipient_policy","schedule_policy","retry_policy"],["scheduled_does_not_mean_delivered","delivered_does_not_mean_authorized_use"],["unauthorized_recipient","expired_subscription","delivery_failed"],["library.consumption.alert_state","library.consumption.report_snapshot","library.consumption.export_writer"],"effect_intents_and_receipts",["evidence.powerbi.subscription","evidence.prometheus.alertmanager"],"runtime_boundary"),
    ...
    crosswalks = [
        ...
        {"legacy_ref":"candidate.product.alert_subscription","canonical_refs":["semantic.alert_rule","semantic.alert_state","semantic.subscription","neighbor.notification_delivery"],"disposition":"split_capabilities_and_neighbor"},
