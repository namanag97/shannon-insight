...
SOURCES = [
    ...
    source("source.application.json_schema", "JSON Schema Core and Validation vocabularies, Draft 2020-12", "https://json-schema.org/draft/2020-12/json-schema-core.html", "JSON Schema project", "application contract structure", "2022", "official_specification"),
    source("source.application.openapi", "OpenAPI Specification 3.2.0", "https://spec.openapis.org/oas/v3.2.0.html", "OpenAPI Initiative", "application interaction contract", "2025", "official_specification"),
    source("source.application.http", "HTTP Semantics, RFC 9110", "https://www.rfc-editor.org/rfc/rfc9110.html", "IETF", "transport safe and idempotent methods", "2022", "standards_body"),
    source("source.application.cloudevents", "CloudEvents Specification 1.0.x", "https://github.com/cloudevents/spec/blob/main/cloudevents/spec.md", "Cloud Native Computing Foundation CloudEvents project", "event envelope", "2022", "official_project"),
    source("source.application.scxml", "State Chart XML (SCXML) 1.0", "https://www.w3.org/TR/scxml/", "W3C", "event-driven state transitions", "2015", "standards_body"),
    source("source.application.bpmn", "Business Process Model and Notation (BPMN) 2.0.2", "https://www.omg.org/spec/BPMN/2.0.2", "Object Management Group", "business process notation", "2014", "official_specification"),
    source("source.application.dmn", "Decision Model and Notation (DMN) 1.4", "https://www.omg.org/spec/DMN/1.4", "Object Management Group", "decision logic notation", "2023", "official_specification"),
    source("source.application.prov_dm", "PROV-DM: The PROV Data Model", "https://www.w3.org/TR/prov-dm/Overview.html", "W3C", "provenance relations", "2013", "standards_body"),
    source("source.application.saga", "Sagas", "https://doi.org/10.1145/38713.38742", "ACM SIGMOD; Hector Garcia-Molina and Kenneth Salem", "long-lived transaction compensation", "1987", "primary_paper"),
    source("source.application.states_language", "Amazon States Language specification", "https://states-language.net/spec.html", "Amazon Web Services", "runtime-specific retry and catch", "2025", "official_project"),
    source("source.application.problem_details", "Problem Details for HTTP APIs, RFC 9457", "https://www.rfc-editor.org/rfc/rfc9457.html", "IETF", "machine-readable HTTP errors", "2023", "standards_body"),
