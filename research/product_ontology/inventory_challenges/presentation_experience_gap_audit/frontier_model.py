...
ROWS = [
    ...
    ("H33", "Analytical Content Management & Collaboration", "MISSING", "SHARED_CONTROL_PLANE_AND_LIBRARY_FAMILY", "RESOLVED_DEFER_PRODUCT_PROMOTION", ["product.data_product_publication"], [], "Cross-artifact containers, membership, references, annotations, comments and reviews are reusable shared control-plane semantics, but independent adoption, economics and exit are not proven; artifact lifecycle remains with each producer product."),
    ("H34", "Subscriptions, Alerts & Insight Delivery", "COLLAPSED", "CROSS_DOMAIN_COMPOSITION", "RESOLVED_RETIRE_COMPOSITE", ["product.bi_reporting"], [], "Producer products own alert evaluation or content subscriptions; a generic external notification-orchestration product owns delivery; case/incident owners retain escalation and business acknowledgment."),
