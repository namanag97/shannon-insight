...
class PackageIdentity:
    ...
    def __post_init__(self) -> None:
        ...
        if (
            self.qualified_contract_scope_count
            or self.portable_offer_count
            or self.executed_vertical_acceptance_count
        ):
            raise ValueError(
                "qualification, portability and acceptance require external evidence and cannot be minted here"
            )
