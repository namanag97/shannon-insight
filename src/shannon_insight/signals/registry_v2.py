...
register(SignalMeta(Signal.FUNCTION_COUNT, int, "file", True, "high_is_bad", 30, "scanning/metrics", 0))
...
register(SignalMeta(Signal.IMPL_GINI, float, "file", True, "high_is_bad", 0.6, "scanning/metrics", 1))
register(SignalMeta(Signal.STUB_RATIO, float, "file", True, "high_is_bad", 0.5, "scanning/metrics", 1))
...
register(SignalMeta(Signal.CONCEPT_COUNT, int, "file", True, "high_is_bad", None, "semantics/concepts", 2))
register(SignalMeta(Signal.CONCEPT_ENTROPY, float, "file", True, "high_is_bad", 1.5, "semantics/concepts", 2))
register(SignalMeta(Signal.NAMING_DRIFT, float, "file", True, "high_is_bad", 0.7, "semantics/naming", 2))
register(SignalMeta(Signal.TODO_DENSITY, float, "file", True, "high_is_bad", 0.05, "scanning/metrics", 1))
register(SignalMeta(Signal.DOCSTRING_COVERAGE, float, "file", True, "high_is_good", None, "semantics/docs", 2))
...
register(SignalMeta(Signal.BETWEENNESS, float, "file", True, "high_is_bad", None, "graph/algorithms", 0))
...
register(SignalMeta(Signal.BLAST_RADIUS_SIZE, int, "file", True, "high_is_bad", None, "graph/algorithms", 0))
register(SignalMeta(Signal.DEPTH, int, "file", False, "neutral", None, "graph/algorithms", 3))  # -1 = orphan
register(SignalMeta(Signal.IS_ORPHAN, bool, "file", False, "high_is_bad", None, "graph/algorithms", 3))
register(SignalMeta(Signal.PHANTOM_IMPORT_COUNT, int, "file", True, "high_is_bad", 0, "graph/algorithms", 3))
register(SignalMeta(Signal.BROKEN_CALL_COUNT, int, "file", True, "high_is_bad", 0, "graph/algorithms", 99))  # Future
register(SignalMeta(Signal.COMMUNITY, int, "file", False, "neutral", None, "graph/algorithms", 0))
register(SignalMeta(Signal.COMPRESSION_RATIO, float, "file", True, "neutral", None, "scanning/metrics", 0))
register(SignalMeta(Signal.SEMANTIC_COHERENCE, float, "file", True, "high_is_good", None, "semantics/coherence", 2))
register(SignalMeta(Signal.COGNITIVE_LOAD, float, "file", True, "high_is_bad", None, "signals/composites", 1))

# IR5t temporal — computed by temporal/ (Phase 3)
register(SignalMeta(Signal.TOTAL_CHANGES, int, "file", True, "high_is_bad", None, "temporal/churn", 3))
register(SignalMeta(Signal.CHURN_TRAJECTORY, str, "file", False, "neutral", None, "temporal/churn", 3))
register(SignalMeta(Signal.CHURN_SLOPE, float, "file", True, "high_is_bad", None, "temporal/churn", 3))
...
register(SignalMeta(Signal.AUTHOR_ENTROPY, float, "file", True, "high_is_good", None, "temporal/churn", 3))
register(SignalMeta(Signal.FIX_RATIO, float, "file", True, "high_is_bad", 0.4, "temporal/churn", 3))
register(SignalMeta(Signal.REFACTOR_RATIO, float, "file", True, "high_is_good", None, "temporal/churn", 3))

# IR5s composites — computed by signals/ (Phase 5)
register(SignalMeta(Signal.RAW_RISK, float, "file", False, "high_is_bad", None, "signals/composites", 5))
register(SignalMeta(Signal.RISK_SCORE, float, "file", False, "high_is_bad", None, "signals/composites", 5))
register(SignalMeta(Signal.WIRING_QUALITY, float, "file", False, "high_is_good", None, "signals/composites", 5))

# IR4 architecture — computed by architecture/ (Phase 4)
register(SignalMeta(Signal.COHESION, float, "module", True, "high_is_good", None, "architecture/metrics", 4))
register(SignalMeta(Signal.COUPLING, float, "module", True, "high_is_bad", None, "architecture/metrics", 4))
register(SignalMeta(Signal.INSTABILITY, float, "module", True, "neutral", None, "architecture/metrics", 4, nullable=True))
register(SignalMeta(Signal.ABSTRACTNESS, float, "module", True, "neutral", None, "architecture/metrics", 4))
register(SignalMeta(Signal.MAIN_SEQ_DISTANCE, float, "module", True, "high_is_bad", None, "architecture/metrics", 4))
register(SignalMeta(Signal.BOUNDARY_ALIGNMENT, float, "module", True, "high_is_good", None, "architecture/metrics", 4))
register(SignalMeta(Signal.LAYER_VIOLATION_COUNT, int, "module", True, "high_is_bad", None, "architecture/metrics", 4))
register(SignalMeta(Signal.ROLE_CONSISTENCY, float, "module", True, "high_is_good", None, "architecture/metrics", 4))
register(SignalMeta(Signal.VELOCITY, float, "module", True, "neutral", None, "temporal/modules", 5))
register(SignalMeta(Signal.COORDINATION_COST, float, "module", True, "high_is_bad", None, "temporal/modules", 5))
register(SignalMeta(Signal.KNOWLEDGE_GINI, float, "module", True, "high_is_bad", None, "temporal/modules", 5))
register(SignalMeta(Signal.MODULE_BUS_FACTOR, float, "module", True, "high_is_good", None, "temporal/modules", 5))
register(SignalMeta(Signal.MEAN_COGNITIVE_LOAD, float, "module", True, "high_is_bad", None, "signals/composites", 5))
register(SignalMeta(Signal.FILE_COUNT, int, "module", True, "neutral", None, "architecture/metrics", 4))
register(SignalMeta(Signal.HEALTH_SCORE, float, "module", False, "high_is_good", None, "signals/composites", 5))

# Global signals — computed by graph/ and signals/ (Phase 0, 3, 5)
register(SignalMeta(Signal.MODULARITY, float, "global", False, "high_is_good", None, "graph/algorithms", 0))
register(SignalMeta(Signal.FIEDLER_VALUE, float, "global", False, "high_is_good", None, "graph/algorithms", 0))
register(SignalMeta(Signal.SPECTRAL_GAP, float, "global", False, "high_is_good", None, "graph/algorithms", 0))
register(SignalMeta(Signal.CYCLE_COUNT, int, "global", False, "high_is_bad", None, "graph/algorithms", 0))
register(SignalMeta(Signal.CENTRALITY_GINI, float, "global", False, "high_is_bad", None, "graph/algorithms", 3))
register(SignalMeta(Signal.ORPHAN_RATIO, float, "global", False, "high_is_bad", None, "graph/algorithms", 3))
register(SignalMeta(Signal.PHANTOM_RATIO, float, "global", False, "high_is_bad", None, "graph/algorithms", 3))
register(SignalMeta(Signal.GLUE_DEFICIT, float, "global", False, "high_is_bad", None, "graph/algorithms", 3))
register(SignalMeta(Signal.WIRING_SCORE, float, "global", False, "high_is_good", None, "signals/composites", 5))
register(SignalMeta(Signal.ARCHITECTURE_HEALTH, float, "global", False, "high_is_good", None, "signals/composites", 5))
register(SignalMeta(Signal.CODEBASE_HEALTH, float, "global", False, "high_is_good", None, "signals/composites", 5))
