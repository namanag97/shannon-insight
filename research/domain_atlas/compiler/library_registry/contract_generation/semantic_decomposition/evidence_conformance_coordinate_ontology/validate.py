...
def main():
 ...
 assert s["routes_with_lexical_discovery_projection"]==91 and s["routes_with_no_member_evidence_signal"]==583
 ...
 print(f"PASS evidence/conformance coordinate ontology: 674 exact members partition losslessly into {s['research_clusters']} proof-scope clusters; all evidence bindings and decisions remain open");return 0
