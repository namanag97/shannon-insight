...
PLATFORM_ADJUDICATION_SUBJECTS = {
    ...
    "candidate.product.platform_estate_tenancy_administration": "product.platform_estate_tenancy_administration",
...
CANDIDATES = [
    c("solution_compiler", "Bounded Intent-to-Solution Compiler Kernel", "platform", "control_plane_product", ["enterprise_architect", "solution_engineer", "domain_model_owner", "assurance_reviewer"], "classify each requirement by resolution frontier and compile sufficiently explicit ratified intent into an immutable evidence-bearing blueprint or complete actionable residual", "a reproducible compiled solution or incomplete solution that routes judgment, physical evidence and open-world discovery to their proper authorities", ["compilation_mode", "semantic_intent_ir", "product_composition_ir", "contract_graph_ir", "application_behavior_ir", "authority_effect_ir", "physical_binding_ir", "deployment_blueprint_ir", "evidence_acceptance_ir", "compiler_residual"], "presumptive_product", ["operated", "stateful", "authority"], ["source.cncf.platform", "source.kubernetes.controller", "source.iso.15288"]),
    ...
    c("platform_estate_tenancy_administration", "Platform Estate & Tenancy Administration", "platform", "control_plane_product", ["platform_estate_administrator", "organization_administrator", "workspace_administrator"], "create, organize, bind, govern, suspend, recover, move and retire organization, account, project and workspace administrative containers", "an evidence-bearing estate hierarchy with explicit attachment inheritance, provider/region/capacity bindings and recoverable lifecycle", ["platform_estate", "administrative_container", "parent_edge", "policy_attachment", "effective_scope_trace", "administrative_delegation_binding", "estate_binding", "estate_change_plan", "estate_exit_manifest"], "strong_product", ["operated", "stateful", "human_ui", "authority", "effectful", "security"], ["source.aws.organizations", "source.gcp.resource_hierarchy", "source.azure.management_groups", "source.snowflake.organizations", "source.fabric.workspaces"]),
    ...
    c("alert_subscription", "Legacy Analytical Alert/Subscription/Delivery Composite", "consumption", "shared_service", ["platform_architect", "analytics_product_owner"], "test whether alert evaluation, content subscription, notification delivery and business acknowledgment can be adopted as one product", "no independent promise: retire and allocate meanings to producer products, an imported notification product and domain workflow owners", ["legacy_bundle_identity"], "merge", ["stateful"], ["source.cloudevents", "source.asyncapi", "source.google.sre.slo"]),
...
SOURCE_SPECS = [
    ...
    ("source.aws.organizations", "Managing organizational units", "Amazon Web Services", "official_product_docs", "https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_ous.html", "Persists one organization root, nested organizational units, accounts, moves and inherited policy controls."),
    ("source.gcp.resource_hierarchy", "About resource hierarchy", "Google Cloud", "official_product_docs", "https://docs.cloud.google.com/resource-manager/docs/cloud-platform-resource-hierarchy", "Persists organization, folder and project hierarchy, exactly-one-parent structure, policy inheritance and lifecycle state."),
    ("source.azure.management_groups", "Organize resources with management groups", "Microsoft Azure", "official_product_docs", "https://learn.microsoft.com/en-us/azure/governance/management-groups/overview", "Persists a directory-rooted management hierarchy, subscription parentage, moves and inherited policy/access scopes."),
    ("source.snowflake.organizations", "Introduction to organizations", "Snowflake", "official_product_docs", "https://docs.snowflake.com/en/user-guide/organizations", "Persists first-class organizations and accounts across regions/clouds with administrator-owned account lifecycle."),
    ("source.fabric.workspaces", "Manage workspaces", "Microsoft Fabric", "official_product_docs", "https://learn.microsoft.com/en-us/fabric/admin/portal-workspaces", "Persists workspace identity, tenant membership, capacity binding, deletion retention and administrative recovery."),
