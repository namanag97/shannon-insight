...
def main() -> int:
    ...
    qualification = read_json(
        ROOT / "research/product_ontology/qualification_program/effective-summary.json"
    )
    industries = read_json(ROOT / "research/domain_atlas/industries/integration-audit.json")
    industry_effective = read_json(
        ROOT / "research/domain_atlas/industries/canonical-reference-effective-summary.json"
    )
    industry_review = read_json(
        ROOT / "research/domain_atlas/industries/canonical-reference-machine-review-summary.json"
    )
    industry_residuals = read_json(
        ROOT / "research/domain_atlas/industries/canonical-reference-residual-summary.json"
    )
    context_map = read_json(ROOT / "research/domain_atlas/context_map/manifest.json")
    source_systems = read_json(
        ROOT / "research/domain_atlas/universes/source_systems/coverage-report.json"
    )
    data_shapes = read_json(
        ROOT / "research/domain_atlas/universes/data_shapes/coverage-report.json"
    )
    providers = read_json(
        ROOT / "research/domain_atlas/compiler/provider_target_registry/manifest.json"
    )
    methods = read_json(
        ROOT / "research/product_ontology/adjudications/analytical_methods/manifest.json"
    )
    horizontal_audit = [
        json.loads(x)
        for x in (
            ROOT
            / "research/analytics_landscape/product_families/consolidation-hardening-audit.jsonl"
        )
    ...
    change_intelligence = read_json(
        ROOT / "research/domain_atlas/ecosystem/change_intelligence/manifest.json"
    )
    coverage_planes = [
        json.loads(x)
    ...
    batches = [
        {
            ...
            "current": {
                "retained_products": readiness["retained_product_count"],
                "effective_vacancies": qualification["effective_evidence_vacancy_count"],
            ...
            "authority_refs": [
                "research/product_ontology/dossier_readiness/summary.json",
                "research/product_ontology/qualification_program/effective-summary.json",
            ],
        },
        {
            ...
            "current": {
                "current_source_families": closure["source_authority_current_family_count"],
                "ratifier_ready_payloads": closure["source_authority_prepared_payload_count"],
                "unprepared_source_families": closure["source_authority_unprepared_family_count"],
                "ratified": 0,
            },
            ...
            "authority_refs": [
                "research/product_ontology/closure_program/source-authority-ratification-batch.jsonl"
            ],
        },
        {
            ...
            "current": {
                "legacy_ambiguities": len(ownership["ambiguities"]),
                "context_candidates": context_map["counts"]["contexts"],
                "context_relations": context_map["counts"]["relations"],
            },
            ...
            "status": "OPEN",
            "authority_refs": [
                "research/domain_atlas/ownership-ambiguities.json",
                "research/domain_atlas/context_map/",
            ],
        },
        {
            ...
            "current": {
                "contexts": context_map["counts"]["contexts"],
                "relations": context_map["counts"]["relations"],
                "acl_decisions": context_map["counts"]["acl_decisions"],
                "explicit_gaps": context_map["counts"]["gaps"],
            },
        ...
        },
        {
            ...
            "current": {
                "audit_requirements": len(horizontal_audit),
                "open_or_partial": sum(
                    r["status"] != "SATISFIED_ENFORCED" for r in horizontal_audit
                ),
                "organization_family_membership_claims": effective_evidence_governance[
                    "effective_membership_claim_count"
                ],
                "strong_exact_membership_claims": effective_evidence_governance[
                    "strong_exact_product_membership_claim_count"
                ],
                "strong_discovered_membership_claims": effective_evidence_governance[
                    "discovered_strong_membership_claim_count"
                ],
                "unreviewed_weak_membership_claims": reviewed_evidence_frontier[
                    "open_weak_membership_claim_count"
                ],
                "reviewed_rejected_membership_claims": reviewed_evidence_frontier[
                    "rejected_reviewed_claim_count"
                ],
                "organization_identities": evidence_governance["unique_organization_count"],
                "identity_relationships_fully_adjudicated": evidence_governance[
        ...
        },
        {
            ...
            "current": {
                "retained_products": readiness["retained_product_count"],
                "complete_candidate_ddd": readiness["full_product_specific_ddd_count"],
                "falsification_contracts": boundary_falsification["falsification_contract_count"],
                "structural_falsification_gaps": boundary_falsification[
                    "structural_falsification_gap_count"
                ],
                "independent_adoption_evidence_complete": boundary_falsification[
                    "product_specific_independent_adoption_evidence_complete_count"
                ],
                "economic_exit_evidence_complete": boundary_falsification[
                    "product_specific_economic_exit_evidence_complete_count"
                ],
                "ratified_boundaries": boundary_falsification["ratified_boundary_count"],
            },
            ...
            "status": "OPEN",
            "authority_refs": [
                "research/product_ontology/dossier_readiness/",
                "research/product_ontology/adjudications/",
            ],
        },
        {
            ...
            "current": {
                "qualification_subjects": qualification["library_qualification_subject_count"],
                "exact_semantic_contract_scopes": contract_scopes["semantic_contract_scope_count"],
                "shared_semantic_contract_scopes": contract_scopes[
                    "shared_semantic_contract_scope_count"
                ],
                "ratified_contract_scopes": contract_scopes["ratified_contract_scope_count"],
                "open_structural_compiler_gaps": readiness["open_structural_compiler_gap_count"],
                "analytical_method_library_contracts": methods["counts"]["library_contract"],
            },
            ...
            "status": "OPEN",
            "authority_refs": [
                "research/product_ontology/qualification_program/library-qualification-subjects.jsonl"
            ],
        },
        {
            ...
            "current": {
                "industry_packs": industries["pack_count"],
                "analytical_cases": vertical_cases,
                "evidence_sources": vertical_evidence,
                "raw_review_queue_records": industry_residuals["raw_queue_records"],
                "ledger_dispositions": industry_effective["ledger_disposition_records"],
                "research_resolved_candidate_records": industry_effective[
                    "ledger_research_resolved_candidate_records"
                ],
                "machine_exact_alias_review_candidates": industry_review[
                    "source_candidate_records"
                ],
                "typed_residual_gap_records": industry_residuals["typed_residual_gap_count"],
                "unclassified_reference_records": industry_residuals[
                    "unclassified_reference_count_after_typing"
                ],
                "semantic_ratifications": industry_residuals["semantic_ratifications_created"],
                "machine_review_batches": industry_review["review_batch_count"],
                "machine_exact_alias_candidate_occurrences": industry_review[
                    "source_candidate_occurrences"
                ],
                "data_shape_needs": vertical_shapes,
                "source_system_needs": vertical_sources,
            },
            ...
            "authority_refs": [
                "research/domain_atlas/industries/integration-audit.json",
                "research/domain_atlas/industries/canonical-reference-effective-summary.json",
                "research/domain_atlas/industries/canonical-reference-machine-review-summary.json",
                "research/domain_atlas/industries/canonical-reference-review-queue.jsonl",
            ],
        },
        {
            ...
            "current": {
                "source_classes": source_systems["class_records"],
                "source_families": len(source_systems["families"]),
                "primary_evidence_records": source_systems["primary_evidence_records"],
                "source_acquisition_identity_stages": len(source_topology["nodes"]),
                "complete_reference_chains": source_reference_chain["governed_data_cuts"],
                "retained_occurrences": source_occurrences["retained_occurrence_count"],
                "source_classes_with_occurrences": source_occurrences[
                    "source_class_count_with_retained_occurrence"
                ],
                "production_qualified_occurrences": source_occurrences[
                    "production_qualified_occurrence_count"
                ],
                "independently_appraised_occurrences": source_occurrences[
                    "independently_appraised_occurrence_count"
                ],
            },
        ...
        },
        {
            ...
            "depends_on": [
                "B06_LIBRARY_CONTRACT_AUTHORITY",
                "B07_INDUSTRY_CANONICAL_REFERENCE_CLOSURE",
            ],
            "scope": "Close type/shape operation totality, information-loss and representation crosswalk obligations.",
            "current": {
                "semantic_value_types": data_shapes["counts"]["semantic_value_types"],
                "logical_shapes": data_shapes["counts"]["logical_shapes"],
                "operation_totality_records": data_shapes["counts"]["operation_totality_records"],
                "crosswalks": data_shapes["counts"]["representation_crosswalks"],
                "historical_coverage_gaps": effective_shape_gaps["historical_gap_count"],
                "end_to_end_closed_gaps": effective_shape_gaps["end_to_end_closed_gap_count"],
                "effective_gap_status_counts": effective_shape_gaps["effective_status_counts"],
            },
        ...
        },
        {
            ...
            "current": {
                "implementation_binding_vacancies": readiness[
                    "implementation_binding_vacancy_count"
                ],
                "provider_registry_implementation_artifacts": providers["counts"][
            ...
            "status": "OPEN",
            "authority_refs": [
                "research/domain_atlas/compiler/provider_target_registry/",
                "research/product_ontology/qualification_program/",
            ],
        },
        {
            "batch_id": "B11_EXACT_SCOPE_CONFORMANCE_AND_INDEPENDENT_APPRAISAL",
            "depends_on": [
                "B10_IMPLEMENTATION_IDENTITY_AND_BUILD",
                "B09_DATA_SHAPE_OPERATION_TOTALITY",
            ],
            "scope": "Execute exact-scope suites, retain counterexamples, and obtain independent appraisal.",
            "current": {
                "qualification_receipts_seed": providers["counts"]["qualification_receipts"],
                "effective_vacancies": qualification["effective_evidence_vacancy_count"],
                "data_sharing_execution_slice_present": True,
            },
            ...
            "status": "OPEN",
            "authority_refs": [
                "research/domain_atlas/compiler/conformance_evaluation/",
                "research/product_ontology/qualification_program/",
            ],
        },
        {
            ...
            "current": {
                "portable_products": qualification["portable_product_count"],
                "concrete_offers_seed": providers["counts"]["concrete_offers"],
            },
        ...
        },
        {
            ...
            "current": {
                "target_occurrences_seed": providers["counts"]["target_occurrences"],
                "resource_cost_records_seed": providers["counts"]["resource_limit_cost_evidence"],
            },
        ...
        },
        {
            ...
            "current": {
                "retained_products": qualification["retained_product_count"],
                "structurally_two_vertical_products": readiness[
                    "two_vertical_structural_product_count"
                ],
                "executed_vertical_acceptance_products": qualification[
                    "executed_vertical_acceptance_product_count"
                ],
                "nominal_gate_obligations": qualification["retained_product_count"] * 2 * 8,
            },
            ...
            "status": "OPEN",
            "authority_refs": [
                "research/product_ontology/qualification_program/product-vertical-acceptance-programs.jsonl",
                "research/domain_atlas/industries/",
            ],
        },
        {
            ...
            "current": {
                "build_ready_products": qualification["build_ready_product_count"],
                "ratified_products": qualification["ratified_product_count"],
            },
        ...
        },
        {
            ...
            "depends_on": [
                "B07_INDUSTRY_CANONICAL_REFERENCE_CLOSURE",
                "B08_SOURCE_SYSTEM_AND_OCCURRENCE_CLOSURE",
                "B09_DATA_SHAPE_OPERATION_TOTALITY",
            ],
            ...
            "current": {
                "coverage_planes": len(coverage_planes),
                "industry_challenge_packs": industries["pack_count"],
                "held_out_challenge_programs_executed": 0,
                "coverage_saturation_claimed": False,
            },
            ...
            "authority_refs": [
                "research/domain_atlas/coverage-planes.jsonl",
                "research/domain_atlas/industries/",
                "research/product_ontology/global_boundary_research/",
            ],
        },
        {
            ...
            "depends_on": [
                "B12_SECOND_IMPLEMENTATION_PORTABILITY_EXIT",
                "B13_PHYSICAL_BINDING_SLO_SECURITY_COST",
                "B16_OPEN_WORLD_COVERAGE_AND_NOVELTY",
            ],
            ...
            "current": {
                "architecture_components": synthesis["components"],
                "operating_modes": synthesis["operating_modes"],
                "ir_stages": synthesis["ir_stages"],
                "typed_transforms": synthesis["ir_transforms"],
                "binding_phases": synthesis["binding_phases"],
                "executed_solution_syntheses": 0,
                "products_promoted_by_architecture": synthesis["products_promoted"],
            },
            ...
            "status": "OPEN_PROGRAM_GATE",
            "authority_refs": [
                "research/product_ontology/solution_synthesis_architecture/",
                "research/domain_atlas/compiler/",
            ],
        },
        {
            "batch_id": "B18_APPLICATION_HUMAN_AUTHORITY_AND_EFFECT",
            "depends_on": [
                "B11_EXACT_SCOPE_CONFORMANCE_AND_INDEPENDENT_APPRAISAL",
                "B13_PHYSICAL_BINDING_SLO_SECURITY_COST",
                "B17_INTENT_TO_SOLUTION_SYNTHESIS",
            ],
            ...
            "current": {
                "human_work_contexts": human_work["files"]["bounded-contexts.jsonl"]["records"],
                "human_work_library_contracts": human_work["files"]["library-contracts.jsonl"][
                    "records"
                ],
                "human_work_decision_points": human_work["files"]["decision-points.jsonl"][
                    "records"
                ],
                "effect_boundary_routes": effect_boundary["target_member_routes"],
                "effect_profiles_supplied": effect_boundary[
                    "effect_boundary_coordinate_profiles_supplied"
                ],
                "qualified_human_work_implementations": human_work[
                    "qualified_implementation_count"
                ],
            },
            ...
            "status": "OPEN_PROGRAM_GATE",
            "authority_refs": [
                "research/domain_atlas/universes/human_work_review_adjudication/",
                "research/domain_atlas/compiler/library_registry/contract_generation/semantic_decomposition/effect_boundary_coordinate_ontology/",
            ],
        },
        {
            ...
            "depends_on": [
                "B14_TWO_VERTICAL_EXECUTED_ACCEPTANCE",
                "B17_INTENT_TO_SOLUTION_SYNTHESIS",
                "B18_APPLICATION_HUMAN_AUTHORITY_AND_EFFECT",
            ],
            ...
            "current": {
                "structural_composition_pilots": vertical_acceptance[
                    "pilot_structural_compositions"
                ],
                "products_with_any_structural_pilot": vertical_acceptance[
                    "products_with_any_structural_pilot"
                ],
                "executed_solution_acceptances": 0,
                "executed_fault_injection_campaigns": 0,
            },
            ...
            "status": "OPEN_PROGRAM_GATE",
            "authority_refs": [
                "research/product_ontology/composition_pilots/deterministic_verticals/",
                "research/domain_atlas/context_map/",
                "research/product_ontology/qualification_program/",
            ],
        },
        {
            ...
            "depends_on": [
                ...
                "B19_MULTI_PRODUCT_SYSTEM_ACCEPTANCE",
            ],
            ...
            "current": {
                "monitored_subjects": change_intelligence["counts"]["monitored-subjects"],
                "verified_change_events": change_intelligence["counts"]["verified-change-events"],
                "migration_invalidation_triggers": change_intelligence["counts"][
                    "migration-invalidation-triggers"
                ],
                "open_change_intelligence_gaps": change_intelligence["counts"]["gaps"],
                "executed_end_to_end_invalidation_propagations": 0,
                "executed_solution_decommissions": 0,
            },
            ...
            "authority_refs": [
                "research/domain_atlas/ecosystem/change_intelligence/",
                "research/product_ontology/qualification_program/",
            ],
        },
    ]
    ...
    summary = {
        ...
        "industry_canonical_reference_ledger_disposition_count": industry_effective[
            "ledger_disposition_records"
        ],
        "industry_canonical_reference_unclassified_count": industry_residuals[
            "unclassified_reference_count_after_typing"
        ],
        "industry_canonical_reference_typed_residual_gap_count": industry_residuals[
            "typed_residual_gap_count"
        ],
        "industry_canonical_reference_research_resolved_count": industry_effective[
            "ledger_research_resolved_candidate_records"
        ],
        "industry_canonical_reference_machine_review_candidate_count": industry_review[
            "source_candidate_records"
        ],
    ...
    (HERE / "master-summary.json").write_text(
