#!/usr/bin/env python3
"""Build deterministic consumption-experience adjudication views."""
...
SPEC = importlib.util.spec_from_file_location("shared_consumption_adjudication_builder", SHARED)
