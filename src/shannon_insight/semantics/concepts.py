...
STOPWORDS = frozenset({
    ...
    "self", "this", "that", "these", "those", "what", "which", "who",
    "none", "true", "false", "null", "nil", "return", "def", "class",
    "func", "function", "var", "let", "const", "import", "from", "export",
    "public", "private", "protected", "static", "final", "abstract",
    "get", "set", "new", "init", "main", "args", "kwargs", "str", "int",
    "float", "bool", "list", "dict", "tuple", "set", "type", "any",
    "object", "value", "key", "item", "data", "result", "output", "input",
    "name", "path", "file", "dir", "config", "options", "settings",
    "error", "exception", "test", "tests", "spec", "mock", "stub",
})
...
class ConceptExtractor:
    ...
    def extract(
        self, syntax: FileSyntax, role: Role
    ) -> tuple[list[Concept], float, int]:
