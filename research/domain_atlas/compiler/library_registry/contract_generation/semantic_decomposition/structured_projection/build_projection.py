...
def build()->dict[str,Any]:
    ...
    dag_nodes=[
      ...
      {"node_id":"dag.semantic.p0-family-identity-grain","work_kind":"p0_family_identity_grain_adjudication","work_refs":["p0_identity_grain/family-axis-packets.jsonl"],"count":46,"exit_gate":"All 23 families have explicit identity/equality and grain/cardinality defaults, exceptions, evidence and unresolved owners."},
      ...
      {"node_id":"dag.semantic.family-applicability","work_kind":"family_axis_owner_decisions","work_refs":["applicability_matrices/family-axis-applicability-matrices.jsonl"],"count":368,"exit_gate":"Every family-axis has a ratified default or unresolved reason and all member exceptions are explicit."},
      {"node_id":"dag.semantic.exact-contracts","work_kind":"exact_library_contract_adjudication","work_refs":["structured_projection/exact-contract-input-candidates.jsonl"],"count":674,"exit_gate":"Every retained library has an exact editioned API, laws, refusals, bounds, evidence and dependency contract or remains rejected/unresolved."},
      {"node_id":"dag.semantic.implementation-conformance","work_kind":"implementation_and_provider_qualification","work_refs":["research/product_ontology/qualification_program"],"count":674,"exit_gate":"Exact implementations pass scoped conformance; portability claims require independent implementations."},
      {"node_id":"dag.semantic.vertical-acceptance","work_kind":"unrelated_vertical_and_product_acceptance","work_refs":["research/product_ontology/composition_pilots"],"count":674,"exit_gate":"Boundary generality and product acceptance are evidenced in at least two unrelated verticals where required."},
    ]
