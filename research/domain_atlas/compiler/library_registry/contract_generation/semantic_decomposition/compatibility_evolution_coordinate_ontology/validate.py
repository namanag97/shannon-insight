...
def main():
 ...
 assert s["routes_with_lexical_evolution_projection"]+s["routes_with_no_evolution_projection"]==len(b["members"])
 ...
 print(f"PASS compatibility/evolution coordinate ontology: {len(b['members'])} exact members partition losslessly into {s['research_clusters']} directional-change clusters; all evidence bindings and decisions remain open");return 0
