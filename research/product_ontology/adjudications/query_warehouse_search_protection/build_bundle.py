#!/usr/bin/env python3
"""Build deterministic views for query/warehouse/search/protection adjudication."""
...
SPEC = importlib.util.spec_from_file_location("shared_query_warehouse_search_protection_builder", SHARED)
