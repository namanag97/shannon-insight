...
def main():
 ...
 assert s["routes_with_lexical_privacy_security_safety_projection"]==85 and s["routes_with_no_privacy_security_safety_projection"]==589
 ...
 print(f"PASS privacy/security/safety coordinate ontology: 674 exact members partition losslessly into {s['research_clusters']} cross-concern clusters; all evidence bindings and decisions remain open");return 0
