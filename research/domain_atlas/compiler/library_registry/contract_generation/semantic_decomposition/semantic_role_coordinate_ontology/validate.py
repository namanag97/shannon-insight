...
def main():
 ...
 assert s["routes_with_lexical_discovery_projection"]+s["routes_with_no_member_role_evidence"]==len(b["members"])
 ...
 print(f"PASS semantic-role coordinate ontology: {len(b['members'])} exact members partition losslessly into {s['research_clusters']} interaction-role clusters; all evidence bindings and decisions remain open");return 0
